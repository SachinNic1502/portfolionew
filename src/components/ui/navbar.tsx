  ...
  return (
    <nav className="sticky top-0 w-full h-14 md:h-16 bg-gray-950 flex flex-row items-center justify-between z-30 backdrop-filter backdrop-blur-md bg-opacity-30">
      ...
      <div className="flex flex-row items-center mx-3">
        <a href="https://www.linkedin.com/in/sachin-rathod-241623250" target="_blank" className="text-white text-xl md:text-2xl  mx-1.5 hover:text-sky-400 transition-all duration-300">
          <FaLinkedin />
        </a>
        {/* <a href="https://x.com/libyzxy0" target="_blank" className="text-white text-xl md:text-2xl mx-1.5 hover:text-sky-400 transition-all duration-300">
          <FaXTwitter />
        </a> */}
        <a href="https://github.com/SachinNic1502" target="_blank" className="text-white text-xl md:text-2xl mx-1.5 hover:text-sky-400 transition-all duration-300">
          <FaGithub />
        </a>
