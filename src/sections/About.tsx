  ...
  return (
    <>
      <section className="pb-5 w-full bg-gray-950" id="about">
        ...
        <div className="mx-6 md:ml-10 md:mr-40 mt-8 space-y-6 md:space-y-8">
          {/* First SlideAnimation */}
          <SlideAnimation>
            <p className="text-gray-400 font-normal text-sm md:text-md lg:text-lg leading-relaxed">
